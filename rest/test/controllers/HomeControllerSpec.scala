...
//      val tmpFile = java.io.File.createTempFile("prefix", "txt")
      ...
      val tmpFile = new File("input//test//sushi.jpg")
      ...
      response.body mustBe "You have sushi 0.98963135"
    }
  }

  def postSource(tmpFile: File): Source[MultipartFormData.Part[Source[ByteString, _]], _] = {
    import play.api.mvc.MultipartFormData._
    Source(FilePart("Dish Identifier", "sushi.jpg", Option("image/jpeg"),
    //Source(FilePart("Dish Identifier", "hello.txt", Option("text/plain"),
